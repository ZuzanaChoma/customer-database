<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Subscriptions.aspx.cs" Inherits="Customer_Database_final.Subscriptions" %>
            ...
            <table class="table table-bordered table-dark">
                ...
                <tbody>
                    <asp:Repeater ID="RepSub" runat="server">
                        <ItemTemplate>
                            <tr>
                                <th><%# Eval("SubscriptionID")%></th>
                                <td><%# Eval("SubscriptionName")%></td>
                                <td><%# Eval("SubscriptionPeriod")%></td>
                                <td><%#Eval("Price")%></td>
